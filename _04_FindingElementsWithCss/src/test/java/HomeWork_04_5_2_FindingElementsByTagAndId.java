...
public class HomeWork_04_5_2_FindingElementsByTagAndId {
    ...
    private By submitButtonLocator = By.cssSelector(".form-submit");
    private By messageErrorLocator = By.cssSelector(".form-error-password-email");
